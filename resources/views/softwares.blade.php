...
<div class="main" style="background-color: #0f1b33">
    ...
    <section class="home home--bg">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h1 class="home__title">SOFTWARES</h1>
                        ...
                        <div class="item">
                            ...
                            <div class="card card--big">
                                <div class="card__cover">
                                    <img src="@if(!empty($software)){{asset($software->cover)}}@endif" alt="">
                        ...
                        <div class="col-6 col-sm-4 col-lg-3 col-xl-2">
                            <div class="card">
                                ...
                                <div class="card__content">
                                    <h3 class="card__title"><a href="{{url('view-software/'.$software->id)}}">@if(!empty($software)){{$software->title}}@endif</a></h3>
                                    <span class="card__category">
                                        <a>@if(!empty($software)){{$software->year}}@endif</a>
                                    </span>
                                    <span class="card__rate"><i class="icon ion-ios-star"></i>8.4</span>
                                </div>
                            </div>
        ...
        <div class="content__head">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <!-- content title -->
                        <h2 class="content__title">TOP SOFTWARES</h2>
                        <!-- end content title -->
