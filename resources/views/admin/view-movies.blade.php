    ...
    <section class="section details">
        ...
        <div class="container">
            <div class="row">
                            ...
                            <div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-7">
                                <div class="card__content">
                                    ...
                                    <ul class="card__meta">
                                        ...
                                        <li><a style="color: #0f1b33" href="{{url('download-movie/'.$movie->id)}}">Download</a></li>
                                    </ul>
                ...
                <!-- player -->
                <div class="col-12 col-xl-6">
                    <video controls crossorigin playsinline poster="{{asset($movie->cover)}}" id="player">
                        <!-- Video files -->
                        <source src="{{asset($movie->filePath)}}" type="{{$movie->fileType}}">
                        

                        <!-- Caption files 
                        <track kind="captions" label="English" srclang="en" src="{{asset($movie->filePath)}}"
                            default>
                        <track kind="captions" label="Français" srclang="fr" src="{{asset($movie->filePath)}}">-->

                        <!-- Fallback for browsers that don't support the <video> element -->
                        <a href="{{asset($movie->filePath)}}" download>Download</a>
                    </video>
