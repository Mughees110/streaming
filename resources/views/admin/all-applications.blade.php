			...
			<div class="row">
				...
				<div class="col-12">
					<div class="main__title">
						...
						<?php
							$sC=\App\Application::count();
						 ?>
						<span class="main__title-stat">@if(!empty($sC)){{$sC}}@endif</span>
						...
						<div class="main__title-wrap">
							...
							<div class="filter" id="filter__sort">
								...
								<ul class="filter__item-menu dropdown-menu scrollbar-dropdown" aria-labelledby="filter-sort">
									<li><a style="color: white" href="{{url('sort-application/'.$created_at)}}">Date created</a></li>
									<li><a style="color: white" href="{{url('sort-application/'.$id)}}">ID</a></li>
									<li><a style="color: white" href="{{url('sort-application/'.$title)}}">TITLE</a></li>
									<li><a style="color: white" href="{{url('sort-application/'.$year)}}">YEAR</a></li>
							...
							<!-- search -->
							<form action="{{url('search-application')}}" class="main__title-form">
								{{ csrf_field() }}
								<input type="text" placeholder="Find application / tv series.." name="title">
								<button type="submit">
						...
						<table class="main__table">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<div class="main__table-text">@if(!empty($application)){{$application->created_at}}@endif</div>
									</td>
