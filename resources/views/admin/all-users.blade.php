					...
					<div class="main__table-wrap">
						<table class="main__table">
							...
							<tbody>
								...
								<tr>
									<td>
										<div class="main__table-text">@if(!empty($user)){{$user->id}}@endif</div>
									</td>
									<td>
										<div class="main__table-text">@if(!empty($user)){{$user->name}}@endif</div>
									</td>
									
									<td>
										<div class="main__table-text">@if(!empty($user)){{$user->email}}@endif</div>
									</td>
									<td>
										<div class="main__table-text">@if(!empty($user)){{$user->password}}@endif</div>
									</td>
									
									<td>
										<div class="main__table-text">@if(!empty($user)){{$user->created_at}}@endif</div>
									</td>
									...
									<td>
										<div class="main__table-btns">
											...
											<a href="#modal-delete<?php echo $user->id ?>" class="main__table-btn main__table-btn--delete open-modal">
								...
								<!-- modal delete -->
								<div id="modal-delete<?php echo $user->id ?>" class="zoom-anim-dialog mfp-hide modal">
									<h6 class="modal__title">Item delete</h6>

									<p class="modal__text">Are you sure to permanently delete this item?</p>

									<div class="modal__btns">
										<a href="{{url('delete-user/'.$user->id)}}" class="modal__btn modal__btn--apply" type="button">Delete</a>
