	...
	<main class="main">
		<div class="container-fluid">
			<div class="row">
				...
				<!-- form -->
				<div class="col-12">
					<form action="{{url('update-application/'.$application->id)}}" method="post" class="form" enctype="multipart/form-data">
						{{ csrf_field() }}
						<div class="row">
							...
							<div class="col-12 col-md-7 form__content">
								<div class="row">
									<div class="col-12">
										<input type="text" name="title" class="form__input" placeholder="Title" value="@if(!empty($application)){{$application->title}}@endif">
									</div>
									...
									<div class="col-12 col-sm-12 col-lg-12">
										<input type="text" name="year" class="form__input" placeholder="Year" value="@if(!empty($application)){{$application->year}}@endif">
									</div>
									...
									<div class="col-12">
										<div class="form__video">
												<label id="movie1" for="form__video-upload">Upload Updated Application</label>
