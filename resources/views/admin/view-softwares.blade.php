                    ...
                    <div class="col-12">
                        <div class="header__content">
                            ...
                            <ul class="header__nav">
                                ...
                                <li class="header__nav-item forSm">
                                    <a class="header__nav-link" href="{{url('softwares')}}" style="color: #00bcd4;">Softwares</a>
                                </li>
                                <li class="header__nav-item forSm">
                                ...
                                <li class="header__nav-item">
                                    ...
                                    <ul class="dropdown-menu header__dropdown-menu" aria-labelledby="dropdownMenuCatalog">
                                        ...
                                        <li><a href="details1.html">Details game</a></li>
...
<!-- dropdown -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="header__search-content">
                            <input type="text" placeholder="Search for a game, TV Series that you are looking for">
    ...
    <div class="sidebar" style="">
          <ul style="padding-left: 10px;">
            ...
            <li style="text-align: left;"><a href="{{url('softwares')}}" style="color: #00bcd4;"><i class="fa fa-cogs" style="font-size:20px; color: #00bcd4;"></i>&nbsp;&nbsp;&nbsp;<b>Softwares</b></a></li><br><br>
    ...
    <section class="section details">
        ...
        <div class="container">
            <div class="row">
                <!-- title -->
                <div class="col-12">
                    <h1 class="details__title">@if(!empty($software)){{$software->title}}@endif</h1>
                </div>
                <!-- end title -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-4 col-md-4 col-lg-3 col-xl-5">
                                <div class="card__cover">
                                    <img src="{{asset($software->cover)}}" alt="">
                                </div>
                            </div>
                            <!-- end card cover -->
                            ...
                            <div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-7">
                                <div class="card__content">
                                    ...
                                    <ul class="card__meta">
                                        ...
                                        <li><span>Release year:</span> @if(!empty($software)){{$software->year}}@endif</li>
                                       
                                        <?php
                                            if(!empty($software->fileSize)){
                                                $size=number_format(round($software->fileSize / 1024 / 1024,4),1);
                                            }
                                            
                                         ?>
                                        <li><span>Size:</span> <a href="#">@if(!empty($size)){{$size}}@endif</a>MB </li>
                                        <li><a style="color: #0f1b33" href="{{url('download-software/'.$software->id)}}">Download</a></li>
                                    </ul>

                                    <div class="card__description card__description--details">
                                       @if(!empty($software)){{$software->description}}@endif
                                    </div>
                                </div>
                            </div>
                            <!-- end card content -->
