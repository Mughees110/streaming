	...
	<main class="main">
		<div class="container-fluid">
			<div class="row">
				...
				<!-- form -->
				<div class="col-12">
					<form action="{{url('store-application')}}" method="post" class="form" enctype="multipart/form-data">
						{{ csrf_field() }}
						<div class="row">
							...
							<div class="col-12 col-md-7 form__content">
								<div class="row">
									...
									<div class="col-12 col-sm-12 col-lg-12">
										<input type="text" name="year" class="form__input" placeholder="Year">
									</div>
									...
									<div class="col-12">
										<div class="form__video">
												<label id="movie1" for="form__video-upload">Upload Application</label>
												<input data-name="#movie1" id="form__video-upload" name="file" class="form__video-upload" type="file" accept="">
											</div>
									</div>
								</div>
							</div>
