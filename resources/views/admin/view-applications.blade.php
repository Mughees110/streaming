    ...
    <section class="section details">
        ...
        <div class="container">
            <div class="row">
                <!-- title -->
                <div class="col-12">
                    <h1 class="details__title">@if(!empty($application)){{$application->title}}@endif</h1>
                </div>
                <!-- end title -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-4 col-md-4 col-lg-3 col-xl-5">
                                <div class="card__cover">
                                    <img src="{{asset($application->cover)}}" alt="">
                                </div>
                            </div>
                            <!-- end card cover -->
                            ...
                            <div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-7">
                                <div class="card__content">
                                    ...
                                    <ul class="card__meta">
                                        ...
                                        <li><span>Release year:</span> @if(!empty($application)){{$application->year}}@endif</li>
                                        
                                        <?php
                                            if(!empty($application->fileSize)){
                                                $size=number_format(round($application->fileSize / 1024 / 1024,4),1);
                                            }
                                            
                                         ?>
                                        <li><span>Size:</span> <a href="#">@if(!empty($size)){{$size}}@endif</a>MB </li>
                                        <li><a style="color: #0f1b33" href="{{url('download-application/'.$application->id)}}">Download</a></li>
                                    </ul>

                                    <div class="card__description card__description--details">
                                       @if(!empty($application)){{$application->description}}@endif
                                    </div>
                                </div>
                            </div>
                            <!-- end card content -->
