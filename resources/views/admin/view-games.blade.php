...
<body class="body">
                    ...
                    <div class="col-12">
                        <div class="header__content">
                            ...
                            <ul class="header__nav">
                                ...
                                <li class="header__nav-item forSm">
                                    <a class="header__nav-link" href="{{url('games')}}" style="color: #00bcd4;">Games</a>
                                </li>
                                <!-- end dropdown -->
    ...
    <div class="sidebar" style="">
          <ul style="padding-left: 10px;">
            ...
            <li style="text-align: left;"><a href="{{url('games')}}" style="color: #00bcd4;"><i class="fa fa-gamepad" style="font-size:20px; color: #00bcd4;"></i>&nbsp;&nbsp;&nbsp;<b>Games</b></a></li><br>
          </ul>
    </div>
    ...
    <section class="section details">
        ...
        <div class="container">
            <div class="row">
                <!-- title -->
                <div class="col-12">
                    <h1 class="details__title">@if(!empty($game)){{$game->title}}@endif</h1>
                </div>
                <!-- end title -->
                            ...
                            <div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-7">
                                <div class="card__content">
                                    ...
                                    <ul class="card__meta">
                                        ...
                                        <li><span>Release year:</span> @if(!empty($game)){{$game->year}}@endif</li>
                                       
                                        <?php
                                            if(!empty($game->fileSize)){
                                                $size=number_format(round($game->fileSize / 1024 / 1024,4),1);
                                            }
                                            
                                         ?>
                                        <li><span>Size:</span> <a href="#">@if(!empty($size)){{$size}}@endif</a>MB </li>
                                        <li><a style="color: #0f1b33" href="{{url('download-game/'.$game->id)}}">Download</a></li>
                                    </ul>
