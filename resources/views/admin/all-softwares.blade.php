			...
			<div class="row">
				...
				<div class="col-12">
					<div class="main__title">
						<h2>Total Softwares</h2>
						<?php
							$sC=\App\Software::count();
						 ?>
						...
						<div class="main__title-wrap">
							...
							<div class="filter" id="filter__sort">
								...
								<ul class="filter__item-menu dropdown-menu scrollbar-dropdown" aria-labelledby="filter-sort">
									<li><a style="color: white" href="{{url('sort-software/'.$created_at)}}">Date created</a></li>
									<li><a style="color: white" href="{{url('sort-software/'.$id)}}">ID</a></li>
									<li><a style="color: white" href="{{url('sort-software/'.$title)}}">TITLE</a></li>
									<li><a style="color: white" href="{{url('sort-software/'.$year)}}">YEAR</a></li>
							...
							<!-- search -->
							<form action="{{url('search-software')}}" class="main__title-form">
								{{ csrf_field() }}
								<input type="text" placeholder="Find software / tv series.." name="title">
								<button type="submit">
						...
						<table class="main__table">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										<div class="main__table-text">@if(!empty($software)){{$software->created_at}}@endif</div>
									</td>
