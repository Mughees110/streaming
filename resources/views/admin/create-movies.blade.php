			...
			<div class="row">
				...
				<div class="col-12">
					<div class="main__title">
						<h2>Add New Movie</h2>
						<a class="form__btn" href="{{url('create-season')}}">Add TV show</a>
					</div>
				</div>
				<div class="col-12">
				...
				<!-- form -->
				<div class="col-12">
					<form action="{{url('store-movie')}}" method="post" class="form" enctype="multipart/form-data">
						{{ csrf_field() }}
						<div class="row">
							...
							<div class="col-12 col-md-7 form__content">
								<div class="row">
									...
									<div class="col-12 col-sm-6 col-lg-4">
										<input type="text" name="year" class="form__input" placeholder="Release year">
									</div>

									<div class="col-12 col-sm-6 col-lg-4">
										<input type="text" name="fileDuration" class="form__input" placeholder="Running time">
									</div>
											...
											<div class="form__season">
												...
												<div class="form__episode">
													<div class="row">
														...
														<?php
															$seasons=\App\Movie::where('type','show')->get();
														 ?>
														<div class="col-12 col-md-6">
															<select class="form__input" id="quality" name="seasonId">
																<option disabled selected>Choose TV series here</option>
																@if(!empty($seasons))
